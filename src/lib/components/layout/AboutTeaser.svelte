...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Nico Waisman",
		role: "Head of Security & Founder",
		image:
			"/generated/image-portrait-of-a-confident-security-leader-.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We didn't build XBOW to make noise. We built it because security tools should do what they say—find real bugs, prove they matter, and make the world a bit harder for attackers. That's actual progress."`}
			/>
